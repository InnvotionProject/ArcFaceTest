...
#define AFR_DEMO_APP_ID         "Cqtamk6vw6tDiHUSeVcDuYHEbm8U99fVRxARW9dCkfp4"
#define AFR_DEMO_SDK_FR_KEY     "DjDYkPAzmnTkDL7ZDWGkBdUaj1syAZf3JJWE8guuNPbL"
#define AFR_DEMO_SDK_FT_KEY     "DjDYkPAzmnTkDL7ZDWGkBdTxv1a8vo3Z1SAymb4ATV1c"
#define AFR_DEMO_SDK_FD_KEY     "DjDYkPAzmnTkDL7ZDWGkBdU65QqETrxnbemp1WCNcf5J"
    ...
    if(0 == dispatch_semaphore_wait(_processSemaphore, 0))
    {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^(){
            ...
            if(nFaceNum > 0)
            {
                ...
                AFR_FSDK_ExtractFRFeature(self->_arcsoftFR, pOffscreenForProcess, &faceInput, &faceModel);
                ...
                for (AFRPerson* person in persons)
                {
                    ...
                    MRESULT mr = AFR_FSDK_FacePairMatching(self->_arcsoftFR, &refFaceModel, &currentFaceModel, &fMimilScore);
            ...
            dispatch_semaphore_signal(self->_processSemaphore);
        });
    }
